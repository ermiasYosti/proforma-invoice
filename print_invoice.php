...
$output = '';
$output .= '<h1> DOLPHIN Trading Private Limited Company</h1><br> ';
$output .= '<h4> Address :+251911282984,+0912,502905,+2511558-9970,FAX:+251-115-548849 </h4><br> ';
$output .= '<h4> ADDIS ABABA, ETHIOPIA</h4><br><br>';
$output .= '<HR> </HR><br>';
$output .= '<table width="100%" border="1" cellpadding="5" cellspacing="0">
	<tr>
	<td colspan="2" align="center" style="font-size:18px"><b>Proforma Invoice</b></td>
	</tr>
	<tr>
	<td colspan="2">
...
foreach($invoiceItems as $invoiceItem){
	...
	<td align="left">'.$invoiceItem["unit"].'</td>
...
$output .= '
	...
	<tr>
	<td align="right" colspan="6"><b>Tax Rate :</b></td>
	...
	<tr>
	<td align="right" colspan="6">Amount Paid:</td>
	<td align="left">'.$invoiceValues['order_amount_paid'].'</td>
	</tr>
	<tr>
	<td align="right" colspan="6"><b>Amount Due:</b></td>
